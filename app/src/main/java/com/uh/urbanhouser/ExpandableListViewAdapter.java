...
public class ExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(b) {
            //view.setBackgroundResource(R.drawable.selectedlistback);
            lb1listheader.setTextColor(context.getResources().getColor(R.color.black));
            lb1listheader.setTypeface(null, Typeface.BOLD);
        }else{
            //view.setBackgroundResource(R.drawable.listback);
            lb1listheader.setTextColor(context.getResources().getColor(R.color.colorPrimaryDark));
