...
public class AdapterSearchPosts extends RecyclerView.Adapter<AdapterSearchPosts.MyHolder> {
    ...
    public AdapterSearchPosts(Context context, List<ModelSearchpost> postList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.searchrow_posts, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, int i) {
        ...
        String localityn = postList.get(i).getLocality();
        String bhkconfig = postList.get(i).getBhkconfig();
        ...
        holder.bhk.setText(bhkconfig);
        //holder.address.setText(address);
        holder.date.setText(date);
        holder.price.setText(price);
        holder.locality.setText(localityn);
    ...
    */
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView address, bhk, price, date, locality, city;
        Button delete, edit;
        ImageButton more;
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            locality = itemView.findViewById(R.id.localityname);
